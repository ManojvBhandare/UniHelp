export const IntroCard = ({
  ...
  return (
    <div
      className={`md:w-[22rem] md:h-[10rem] w-[16rem] h-[15rem] ${bgClass} ${textColor} rounded-2xl flex justify-center md:flex-row flex-col items-center gap-3 md:p-[1.5rem] p-[1rem] cursor-pointer`}
